            ...
            <div className={`flex items-center ${sidebarCollapsed ? 'justify-center' : 'space-x-3'}`}>
              ...
              {!sidebarCollapsed && (
                <div className="flex-1">
                  <h1 className="font-bold text-lg text-text">Mentor Portal</h1>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-3">
                <div className="hidden sm:flex items-center space-x-2 px-3 py-1.5 bg-gray-100 rounded-lg">
                  ...
                  <div>
                    <p className="text-sm font-medium text-text">Mentor</p>
          ...
          <div className="fixed inset-0 bg-black/50 z-40 lg:hidden" onClick={() => setMobileMenuOpen(false)}>
            <div className="fixed inset-y-0 left-0 w-64 bg-white shadow-xl" onClick={e => e.stopPropagation()}>
              ...
              <nav className="p-4">
                ...
                <button
                  onClick={handleLogout}
                  className="mt-6 w-full flex items-center justify-center space-x-2 p-3 rounded-lg bg-danger/10 text-danger hover:bg-danger/20 transition-colors"
                >
                  <LogOut size={18} />
